...
(define text-field-af0
  (new text-field%
       ...
       (min-width 162)
       (stretchable-width #f) 
       (init-value (number->string (af0-v)))))
...
(define text-field-start-af
  (new text-field%
       ...
       (min-width 150)
       (stretchable-width #f) 
       (init-value (number->string (start-af-v)))))
(define text-field-end-af
  (new text-field%
       ...
       (min-width 150)
       (stretchable-width #f) 
       (init-value (number->string (end-af-v)))))
...
(define text-field-ap0
  (new text-field%
       ...
       (min-width 162)
       (stretchable-width #f) 
       (init-value (number->string (ap0-v)))))
...
(define text-field-step-aw
  (new text-field%
       ...
       (min-width 150)
       (stretchable-width #f) 
       (init-value (number->string (step-aw-v)))))

;画笔参数:
(define group-box-panel-pen
  (new group-box-panel%
       (parent panel-setting)
       (label "画笔参数")
       (alignment (list 'right 'top))
